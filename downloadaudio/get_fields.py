...
# # downloaded.
expression_fields = [u'mm_focusmorph', u'expression', u'word']
...
reading_keys = [u'mm_focusmorph_reading', u'reading', u'kana', u'かな', u'仮名']
...
audio_field_keys = [u'audio', u'sound', u'mm_focusmorph_audio']
