...
from kdsg_sac.cjklib.exception import (ConversionError, AmbiguousConversionError,
    InvalidEntityError, UnsupportedError)
from kdsg_sac.cjklib import dbconnector
from kdsg_sac.cjklib.reading import operator as readingoperator
import kdsg_sac.cjklib.reading
from kdsg_sac.cjklib.util import titlecase, istitlecase, cachedproperty
...
class ReadingConverter(object):
    ...
    def __init__(self, *args, **options):
        ...
        self._f = kdsg_sac.cjklib.reading.ReadingFactory(dbConnectInst=self.db)
